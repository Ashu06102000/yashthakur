...
const Hero = () => {
  return (
    <section className="relative flex items-center flex-col flex-1 overflow-hidden min-h-[calc(100vh-89px)]">
      ...
      {/* ── Main content ── */}
      <div className="relative flex max-w-screen-lg m-auto flex-col items-center justify-center flex-1 px-14 py-10">

        {/* HELLO! watermark — Road Rage */}
        <span
          aria-hidden="true"
          className="font-road-rage absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-[72%] text-[clamp(100px,22vw,280px)] text-black/[0.09] whitespace-nowrap select-none pointer-events-none leading-none tracking-normal"
        >
          HELLO!
        </span>
        ...
        {/* Two-column copy */}
        <div className="grid grid-cols-2 gap-x-20 gap-y-10 mt-16 relative z-10">
          {/* Left */}
          <div>
          ...
          <div className="flex flex-col justify-between">
            ...
            <a
              ...
              className="font-sans text-base flex flex-col text-black underline decoration-1 underline-offset-2 text-right mt-5"
            >
