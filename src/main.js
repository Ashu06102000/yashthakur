...
manager.onLoad = function () {
  loadingScreenButton.style.border = "1px solid #acacaca6";
  loadingScreenButton.style.background = "transparent";
  loadingScreenButton.style.color = "black";
  ...
  function handleEnter(withSound = true) {
    ...
    loadingScreenButton.style.background = "transparent";
    loadingScreenButton.style.color = "black";
    loadingScreenButton.textContent = "नमस्ते";
    loadingScreenButton.style.cursor = "pointer";
