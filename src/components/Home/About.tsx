const About = () => {
  return (
    <div className="flex w-full">
      <div className=" h-min mt-[10em] border-ra flex flex-col gap-2">
        ...
        <div className="border-ra border-y-[1px] mt-[40em]">
      ...
      <div className="border-[1px] relative border-t-0 border-ra h-full w-full">
        ...
        <div className="h-full relative flex justify-center p-8">
          <video
            className="h-72 absolute top-[12%]"
      ...
      <div className="h-full p-8 flex flex-col gap-16 w-2/3 ">
        ...
        <div className="flex flex-wrap gap-2 mt-[15em]">
          <div className="relative flex bg-white p-4 gap-2">
