...
export default function TransitionScribble() {
    useEffect(() => {
        ...
        const transitionScribblePath = transitionScribbleSvg?.querySelector('path');
        ...
        const runScribbleAnimation = (e) => {
            ...
            if (!pathLength) {
                window.setTimeout(() => runScribbleAnimation(null), 50);
                return;
            }
            ...
            const randomColor =
                transitionColors[
                Math.floor(Math.random() * transitionColors.length)
                ];
            ...
            const logoColor = lightColors.includes(randomColor)
                ? '#000'
                : '#fff';
            ...
            if (!transitionLogo) {
                ...
                transitionLogo.textContent = 'iamyash';
        ...
        const timer = window.setTimeout(startTransition, 120);
