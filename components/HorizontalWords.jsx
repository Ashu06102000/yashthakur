        ...
        <section ref={sectionRef} className="horizontal-words-section content-section">
            <div className="horizontal-words__relative">
                <div className="horizontal-words__sticker-svg">
                    ...
                    <h2
                        ...
                        aria-label="I love building things that people enjoy using"
                    >
            ...
            <div className="horizontal-words__bottom-text">
                <div className="horizontal-words__bottom-text-l">
                    I genuinely enjoy building products that solve real problems <em>and</em> create meaningful experiences.<br />
                    Every project is a chance to learn, improve, and build<br />
                    something people truly enjoy using.
                </div>
            </div>
        </section>
    );
